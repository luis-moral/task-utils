 ...
 */
package es.molabs.task.time.simple.test;
...
import es.molabs.task.time.simple.SimpleMaxTimeTask;
import es.molabs.task.time.simple.SimpleRepeatTimeTask;
import es.molabs.task.time.simple.SimpleTimeTask;
import es.molabs.task.time.simple.SimpleWaitTimeTask;

@RunWith(MockitoJUnitRunner.class)
public class SimpleTimeTaskTest 
{
	@Test
	...
	private class TestTimeTask extends SimpleTimeTask
	{
	...
	private class TestRepeatTimeTask extends SimpleRepeatTimeTask
	{
	...
	private class TestMaxTimeTask extends SimpleMaxTimeTask
	{
	...
	private class TestWaitTimeTask extends SimpleWaitTimeTask
	{
